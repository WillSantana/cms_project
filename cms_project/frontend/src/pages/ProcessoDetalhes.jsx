...
import { ArrowLeft, Calendar, Building2, FileText, Mail, Phone } from 'lucide-react'
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 mb-8">
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-lg">{processo.telefone || 'Não informado'}</p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-lg">{processo.email || 'Não informado'}</p>
                </div>
              </div>
            </div>
